...
public class Game1Activity extends Activity implements SensorEventListener {
	...
	public class MyView extends View implements Runnable
    {
        ...
        private void update(){
        	//Verificaзгo para a bola nгo sair do ecrг
        	...
        	//Adicionar coordenadas da bola а lista
        	listaX.add(xx);
        	listaY.add(yy);
        ...
        public void draw(Canvas canvas){
        	...
        	//Se for a primeira vez que estiver a executar, coloca a bola no centro de ecrг
        	if(primeiraVez){
         		yy=getHeight()/2;
         		xx=getWidth()/2;
